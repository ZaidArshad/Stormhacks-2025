...
from singletons.singletons import uiEvtManager, renderer
...
class DialogueWithChoice(baseUIElement):
    ...
    def __init__(self, x, y, buttonAssetUri=None, surface=None, questionText : TextObject = None, optionOneText : TextObject = None, optionTwoText : TextObject = None, optionThreeText : TextObject = None, optOneCallback: any = None, optTwoCallback: any = None, optThreeCallback: any = None):
        ...
        if optionOneText != None:
            ...
            btnOne = Button(0,0, surface= transparent_surface, buttonHoverAssetUri= Path("assets/UI/hover/startGameHover.png"),  TextObject=optionOneText, callback=optOneCallback)
            ...
            uiEvtManager.register(btnOne)
        if optionTwoText != None:
            size = optionTwoText.getCompiled().get_size()
            transparent_surface = pygame.Surface((size[0] + 15, size[1] + 15), pygame.SRCALPHA)
            btnTwo = Button(0,0, surface= transparent_surface, buttonHoverAssetUri= Path("assets/UI/hover/startGameHover.png"),  TextObject=optionTwoText, callback=optTwoCallback)
            ...
            uiEvtManager.register(btnTwo)
        if optionThreeText != None:
            size = optionThreeText.getCompiled().get_size()
            transparent_surface = pygame.Surface((size[0] + 15, size[1] + 15), pygame.SRCALPHA)
            btnThree = Button(0,0, surface= transparent_surface, buttonHoverAssetUri= Path("assets/UI/hover/startGameHover.png"),  TextObject=optionThreeText, callback=optThreeCallback)
            ...
            uiEvtManager.register(btnThree)
